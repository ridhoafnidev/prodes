package com.mrii.prodes.viewmodel.user;
...
import com.mrii.prodes.repository.user.UserRepository;
...
public class UserViewModel extends PSViewModel {
    ...
    public String latValue = "", lngValue = "", addressValue = "";
    public User user;
...
//    }
    ...
    public LiveData<Resource<User>> uploadImage(Context context, String filePath, Uri uri, String userId) {
        ...
        return Transformations.switchMap(imgObj, obj -> {
            ...
            return this.repository.uploadImage(context, filePath, uri, userId, Constants.PLATFORM);
        });
...
//    }
    ...
    // phone login User
    public void setPhoneLoginUser(String phoneId, String phone, String deviceToken) {
        TmpDataHolder tmpDataHolder = new TmpDataHolder();
