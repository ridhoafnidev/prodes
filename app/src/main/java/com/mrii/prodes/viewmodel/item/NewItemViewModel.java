...
public class NewItemViewModel extends PSViewModel {
    ...
    private final MutableLiveData<NewItemViewModel.ItemTmpDataHolder> fiveItemRekomendationListByKeyObj = new MutableLiveData<>();

    private final LiveData<Resource<Boolean>> nextPagepopularItemListByKeyData;
    private final MutableLiveData<NewItemViewModel.ItemTmpDataHolder> nextPageItemListByKeyObj = new MutableLiveData<>();

    public ItemParameterHolder popularItemParameterHolder = new ItemParameterHolder().getRecentItem();
    ...
    @Inject
    NewItemViewModel(ItemRepository repository)
    {
    ...
    // region getItemList
        ...
        public void setFiveREkomendationItemListByKeyObj(String loginUserId, String limit, String offset, ItemParameterHolder parameterHolder) {
            NewItemViewModel.ItemTmpDataHolder tmpDataHolder = new NewItemViewModel.ItemTmpDataHolder(limit, offset, loginUserId, parameterHolder);
