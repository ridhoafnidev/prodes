...
public class Item {
    ...
    public final String provinsiId;

    @SerializedName("kabupaten_kota_id")
    public final String kabupatenKotaId;

    @SerializedName("kecamatan_id")
    public final String kecamatanId;

    @SerializedName("kelurahan_desa_id")
    public final String kelurahanDesaId;
    ...
    @Embedded(prefix = "umkm_")
    @SerializedName("umkm")
    public final Umkm umkm;
    ...
    public Item(@NonNull String id, String catId, String subCatId, String itemTypeId, String itemPriceTypeId, String itemCurrencyId, String conditionOfItem, String description, String highlightInfo, String price, String dealOptionId, String brand, String businessMode, String isSoldOut, String title, String address, String lat, String lng, String status, String addedDate, String addedUserId, String updatedDate, String updatedUserId, String updatedFlag, String touchCount, String favouriteCount, String provinsiId, String kabupatenKotaId, String addedDateStr, String photoCount, String dealOptionRemark, Image defaultPhoto, ItemCategory category, ItemSubCategory subCategory, ItemType itemType, ItemPriceType itemPriceType, ItemCurrency itemCurrency, ItemLocation itemLocation, ItemCondition itemCondition, ItemDealOption itemDealOption, User user, String isOwner, String isFavourited, String isPaid, String kecamatanId, String kelurahanDesaId, String paidStatus, Umkm umkm) {
        this.id = id;
        this.catId = catId;
        ...
        this.kabupatenKotaId = kabupatenKotaId;
        ...
        this.kelurahanDesaId = kelurahanDesaId;
