...
public interface Constants {
    ...
    String INFO_COVID_ID = "INFO_COVID_ID";
    ...
    int RESULT_CODE__CAT_FILTER = 2020;
    ...
    int RESULT_CODE__FROM_PROFILE_SELLER_VIEW = 2021;
    int RESULT_CODE__FROM_PROFILE_BUYER_VIEW = 2021;
    ...
    String NAMA_UMKM = "NAMA_UMKM";
    String USER_DETAIL_ADDRESS = "USER_DETAIL_ADDRESS";
    ...
    String BUYER = "pembeli";
    String SELLER = "penjual";
...
//    String VERIFY_EMAIL_TYPE = "VERIFY_EMAIL_TYPE";
    ...
    String ITEM_CATEGORY_ID = "CATEGORY_ID";
    ...
    String FILTERING_CATEGORY_FILTER = "cf"; // Don't Change
    ...
    // region Info Development
    String NAME_MENU_DEVELOPMENT = "TITLE_DEVELOPMENT";
