...
import com.mrii.prodes.db.CityDao;
import com.mrii.prodes.db.CityMapDao;
import com.mrii.prodes.db.DeletedObjectDao;
import com.mrii.prodes.db.HistoryDao;
import com.mrii.prodes.db.ImageDao;
import com.mrii.prodes.db.InfoCovidDao;
import com.mrii.prodes.db.ItemCategoryDao;
import com.mrii.prodes.db.ItemCollectionHeaderDao;
...
import com.mrii.prodes.db.ItemLocationDao;
import com.mrii.prodes.db.ItemMapDao;
...
import com.mrii.prodes.db.MessageDao;
import com.mrii.prodes.db.NotificationDao;
import com.mrii.prodes.db.PSAppInfoDao;
import com.mrii.prodes.db.PSAppVersionDao;
...
import com.mrii.prodes.db.UserMapDao;
import com.mrii.prodes.utils.AppLanguage;
import com.mrii.prodes.utils.Connectivity;
import com.mrii.prodes.utils.LiveDataCallAdapterFactory;
...
class AppModule {
    ...
    @Singleton
    @Provides
    BannerDao provideNewsBannerDao(PSCoreDb db) {
        return db.bannerDao();
    }

    @Singleton
    @Provides
    InfoCovidDao provideInfoCovidDao(PSCoreDb db) {
        return db.infoCovidDao();
    }
