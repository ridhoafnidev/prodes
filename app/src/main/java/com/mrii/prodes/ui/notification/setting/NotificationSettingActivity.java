package com.mrii.prodes.ui.notification.setting;
...
import com.mrii.prodes.databinding.ActivityNotificationSettingBinding;
...
public class NotificationSettingActivity extends PSAppCompactActivity {
    ...
    private void initUI(ActivityNotificationSettingBinding binding) {
        ...
        // Toolbar
        initToolbarBackHome(binding.toolbar, getResources().getString(R.string.notification_setting__title));
