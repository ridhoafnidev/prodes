...
import com.mrii.prodes.databinding.FragmentItemEntryBinding;
import com.mrii.prodes.databinding.FragmentMapsTestBinding;
 ...
 */
public class MapsTestFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    @VisibleForTesting
    private AutoClearedValue<FragmentMapsTestBinding> binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentMapsTestBinding dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_maps_test, container, false, dataBindingComponent);
...
//                imagePath = cursor.getString(columnIndex);
    ...
    protected void initUIAndActions() {
        ...
        if (getActivity() instanceof MainActivity) {
            ...
            ((MainActivity)getActivity()).setToolbarText(toolbar, getString(R.string.item_entry_toolbar));
            setHasOptionsMenu(true);
        }
        ...
        binding.get().mapViewButton.setOnClickListener(v -> {
            ...
            if(itemViewModel.itemId.equals(Constants.ADD_NEW_ITEM)){
                navigationController.navigateToMapActivity(MapsTestFragment.this.getActivity(), selectedLng, selectedLat, Constants.MAP_PICK);
            }else {
                navigationController.navigateToMapActivity(MapsTestFragment.this.getActivity(), itemViewModel.mapLng, itemViewModel.mapLat, Constants.MAP_PICK);
            }
        ...
        binding.get().submitButton.setOnClickListener(view -> {
            ...
            if ( ( itemViewModel.firstImagePath.equals("") && firstImageId.equals("") )
                ...
                psDialogMsg.showWarningDialog(MapsTestFragment.this.getString(R.string.item_entry_need_image), MapsTestFragment.this.getString(R.string.app__ok));
                psDialogMsg.show();
            } else if (binding.get().titleEditText.getText().toString().isEmpty()) {
                psDialogMsg.showWarningDialog(MapsTestFragment.this.getString(R.string.item_entry_need_list_title), MapsTestFragment.this.getString(R.string.app__ok));
                psDialogMsg.show();
            }
            else if (binding.get().categoryTextView.getText().toString().isEmpty()) {
                psDialogMsg.showWarningDialog(MapsTestFragment.this.getString(R.string.item_entry_need_category), MapsTestFragment.this.getString(R.string.app__ok));
                psDialogMsg.show();
            }
...
//            }
                ...
                psDialogMsg.showWarningDialog(MapsTestFragment.this.getString(R.string.item_entry_need_item_condition), MapsTestFragment.this.getString(R.string.app__ok));
                psDialogMsg.show();
            }
...
//            }
                ...
                psDialogMsg.showWarningDialog(MapsTestFragment.this.getString(R.string.item_entry_need_description), MapsTestFragment.this.getString(R.string.app__ok));
                psDialogMsg.show();
            } else if (binding.get().priceEditText.getText().toString().isEmpty()) {
                psDialogMsg.showWarningDialog(MapsTestFragment.this.getString(R.string.item_entry_need_price), MapsTestFragment.this.getString(R.string.app__ok));
                psDialogMsg.show();
            }
...
//            }
                ...
                MapsTestFragment.this.getImagePathList();

                MapsTestFragment.this.checkIsShop();

                if (itemViewModel.itemId != null) {
                    if (!itemViewModel.itemId.equals(Constants.ADD_NEW_ITEM)) {//edit
                        itemViewModel.setUploadItemObj(MapsTestFragment.this.catId, MapsTestFragment.this.subCatId, MapsTestFragment.this.typeId, MapsTestFragment.this.priceTypeId, MapsTestFragment.this.currencyId, MapsTestFragment.this.conditionId, MapsTestFragment.this.locationId,
                                binding.get().remarkEditText.getText().toString(), binding.get().descEditText.getText().toString(),
                                binding.get().highlightInfoEditText.getText().toString(), binding.get().priceEditText.getText().toString(), MapsTestFragment.this.dealOptionId,
                    ...
                    case SUCCESS:
                        if (result.data != null) {
                            if (selected) {
                                ...
                                Toast.makeText(getActivity(), "Produk berhasil di upload", Toast.LENGTH_SHORT).show();
                                progressDialog.cancel();
...
//                            Toast.makeText(ItemEntryFragment.this.getActivity(), "Success image : "+toastImageCount+" uploaded", Toast.LENGTH_SHORT).show();
                            ...
                            if (imagePathList.size() > imageCount) {
                                MapsTestFragment.this.callImageUpload(imageCount);//first is one
                            } else {
...
//                        }
                    ...
                    case ERROR:
                        ...
                        Toast.makeText(MapsTestFragment.this.getActivity(), "Error", Toast.LENGTH_SHORT).show();
                        progressDialog.cancel();
                        psDialogMsg.showErrorDialog(MapsTestFragment.this.getString(R.string.error_message__image_cannot_upload), MapsTestFragment.this.getString(R.string.app__ok));
                        psDialogMsg.show();
                        break;
                }
