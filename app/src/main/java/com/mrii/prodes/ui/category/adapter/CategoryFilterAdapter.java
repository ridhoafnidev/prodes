package com.mrii.prodes.ui.category.adapter;
...
import com.mrii.prodes.databinding.ItemCategoryFilterBinding;
import com.mrii.prodes.databinding.ItemSubCategoryFilterBinding;
import com.mrii.prodes.ui.category.categoryfilter.Grouping;
...
public class CategoryFilterAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int i, int childPosition, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (categoryList.get(i).id.equals(catId) && subCategory.id.equals(subCatId)) {
            subCategoryItemBinding.subcategoryItem.setCompoundDrawablesWithIntrinsicBounds(null, null, viewGroup.getResources().getDrawable(R.drawable.ic_done_primary), null);
