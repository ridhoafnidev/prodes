...
import com.mrii.prodes.databinding.FragmentFilterBinding;
...
public class FilteringFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().setItemName.setHint(R.string.sf__empty);
    ...
    private void setSortingSelection(int index) {
        ...
        if (index == 0) {
            binding.get().recentButton.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(R.drawable.ic_done_primary), null);

            itemViewModel.holder.order_by = Constants.FILTERING_ADDED_DATE;
            itemViewModel.holder.order_type = Constants.FILTERING_DESC;

        } else {
            binding.get().recentButton.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }

        if (index == 1) {
            binding.get().popularButton.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(R.drawable.ic_done_primary), null);

            itemViewModel.holder.order_by = Constants.FILTERING_TRENDING;
            itemViewModel.holder.order_type = Constants.FILTERING_DESC;

        } else {
            binding.get().popularButton.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }

        if (index == 2) {
            binding.get().highestButton.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(R.drawable.ic_done_primary), null);

            itemViewModel.holder.order_by = Constants.FILTERING_NAME;
            itemViewModel.holder.order_type = Constants.FILTERING_ASC;

        } else {
            binding.get().highestButton.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }

        if (index == 3) {
            binding.get().lowestButton.setCompoundDrawablesWithIntrinsicBounds(null, null, getResources().getDrawable(R.drawable.ic_done_primary), null);

            itemViewModel.holder.order_by = Constants.FILTERING_NAME;
            itemViewModel.holder.order_type = Constants.FILTERING_DESC;

        } else {
            binding.get().lowestButton.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }
    }
