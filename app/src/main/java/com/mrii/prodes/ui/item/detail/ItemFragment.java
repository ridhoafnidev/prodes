...
import com.mrii.prodes.utils.ViewAnimationUtil;
 ...
 */
public class ItemFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
...
//        });
        ...
        binding.get().soldTextView.setOnClickListener(v -> {
            if (binding.get().soldTextView.getText().equals(getResources().getString(R.string.item_detail__mark_sold))) {
                showConfirmSoldDialog(getString(R.string.item_detail__confirm_sold_out), getString(R.string.app__ok), getString(R.string.message__cancel_close));
            }
        });

        binding.get().deleteButton.setOnClickListener(v -> {
            showConfirmDeleteDialog(getString(R.string.item_detail__confirm_delete), getString(R.string.app__ok), getString(R.string.message__cancel_close));
        });
...
//        });
    ...
    private void showConfirmSoldDialog(String description, String oke, String  cancel){
    ...
    private void showConfirmDeleteDialog(String description, String oke, String  cancel){
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setTitle("Peringatan");
        builder.setMessage(description);
        builder.setPositiveButton(oke, new DialogInterface.OnClickListener() {
    ...
    protected void initAdapters() {
        ...
        ItemHorizontalListAdapter relatedAdapter = new ItemHorizontalListAdapter(dataBindingComponent, item ->
                navigationController.navigateToRelatedItemDetailActivity(this.getActivity(), item.id, item.title, item.catId, item.subCatId), this);
