package com.mrii.prodes.ui.category.categoryfilter;
...
import com.mrii.prodes.databinding.TypeFilterBinding;
import com.mrii.prodes.ui.category.adapter.CategoryFilterAdapter;
...
public class CategoryFilterHomeFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
...
//                int lastPosition = absListView.getLastVisiblePosition();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.clear) {
            ...
            if(getActivity() != null){
                navigationController.navigateBackToHomeFeaturedFragment(CategoryFilterHomeFragment.this.getActivity(), this.catId, this.subCatId);
            }
        }
    ...
    private void initializeAdapter() {
        CategoryFilterAdapter nvAdapter = new CategoryFilterAdapter(dataBindingComponent, (catId, subCatId) -> {
            ...
            CategoryFilterHomeFragment.this.assignCategoryId(catId, subCatId);

            if (getActivity() != null) {
                navigationController.navigateBackToHomeFeaturedCatFragment(CategoryFilterHomeFragment.this.getActivity(), catId, subCatId);
                CategoryFilterHomeFragment.this.getActivity().finish();
//                navigationController.navigateToTypeFilterCategoryFragment(CategoryFilterFragment.this.getActivity(), catId,
//                        subCatId);
