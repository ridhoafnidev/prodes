package com.mrii.prodes.ui.item.search.searchlist;
...
public class SearchListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initAdapters() {
        ...
        ItemVerticalListAdapter nvAdapter = new ItemVerticalListAdapter(dataBindingComponent, item -> navigationController.navigateToItemDetailActivity(SearchListFragment.this.getActivity(), item.id, item.title, item.catId, item.subCatId), this);
