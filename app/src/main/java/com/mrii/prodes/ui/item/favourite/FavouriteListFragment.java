...
import com.mrii.prodes.databinding.FragmentFavouriteListBinding;
...
//            }
        ItemVerticalListAdapter nvAdapter = new ItemVerticalListAdapter(dataBindingComponent, item -> navigationController.navigateToItemDetailActivity(getActivity(), item.id, item.title, item.catId, item.subCatId), this);
