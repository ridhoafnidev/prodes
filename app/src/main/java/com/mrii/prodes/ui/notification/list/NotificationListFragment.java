package com.mrii.prodes.ui.notification.list;
...
import com.mrii.prodes.databinding.FragmentNotificationListBinding;
import com.mrii.prodes.ui.common.DataBoundListAdapter;
import com.mrii.prodes.ui.common.PSFragment;
import com.mrii.prodes.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.mrii.prodes.viewobject.Noti> notificationList) {
