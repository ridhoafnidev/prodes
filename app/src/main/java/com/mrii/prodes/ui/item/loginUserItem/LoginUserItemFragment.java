...
import com.mrii.prodes.databinding.FragmentLoginUserItemBinding;
        ...
        ItemVerticalListAdapter userItemAdapter = new ItemVerticalListAdapter(dataBindingComponent,
                new ItemVerticalListAdapter.NewsClickCallback() {
                    ...
                    public void onClick(Item item) {
                        navigationController.navigateToItemDetailActivity(LoginUserItemFragment.this.getActivity(), item.id, item.title, item.catId, item.subCatId);
                    }
                },this);
