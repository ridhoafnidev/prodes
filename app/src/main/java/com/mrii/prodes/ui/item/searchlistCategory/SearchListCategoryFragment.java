...
import com.mrii.prodes.databinding.FragmentItemListBinding;
import com.mrii.prodes.databinding.FragmentItemListCategoryBinding;
...
public class SearchListCategoryFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    @VisibleForTesting
    private AutoClearedValue<FragmentItemListCategoryBinding> binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        FragmentItemListCategoryBinding dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_item_list_category, container, false, dataBindingComponent);
    ...
    protected void initUIAndActions() {
        ...
        //binding.get().backSub.setOnClickListener(this::ButtonClick);
    ...
    protected void initAdapters() {
        ...
        ItemVerticalListAdapter nvAdapter = new ItemVerticalListAdapter(dataBindingComponent, item -> navigationController.navigateToItemDetailActivity(SearchListCategoryFragment.this.getActivity(), item.id, item.title, item.catId, item.subCatId), this);
    ...
    private void ButtonClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.typeButton:
                ...
                navigationController.navigateToTypeFilterFragment(SearchListCategoryFragment.this.getActivity(), itemViewModel.holder.cat_id,
...
//                ButtonSheetClick();
               // Toast.makeText(getContext(),"Map Activity",Toast.LENGTH_SHORT).show();
