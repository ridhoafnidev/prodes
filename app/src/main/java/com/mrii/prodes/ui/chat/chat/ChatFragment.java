...
import com.mrii.prodes.databinding.FragmentChatBinding;
import com.mrii.prodes.databinding.ItemRatingEntryBinding;
import com.mrii.prodes.ui.chat.adapter.ChatListAdapter;
...
import com.mrii.prodes.viewobject.messageHolder.Chat;
import com.mrii.prodes.viewobject.messageHolder.Message;
import com.mrii.prodes.viewobject.messageHolder.UserStatusHolder;
...
public class ChatFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().itemCardView.setOnClickListener(v -> navigationController.navigateToItemDetailActivity(getActivity(), chatViewModel.itemId, chatViewModel.itemName, Constants.EMPTY_STRING, Constants.EMPTY_STRING));
