...
import com.mrii.prodes.databinding.FragmentLoginUserPaidItemBinding;
import com.mrii.prodes.ui.common.DataBoundListAdapter;
import com.mrii.prodes.ui.common.PSFragment;
import com.mrii.prodes.ui.item.promote.adapter.ItemPromoteVerticalListAdapter;
        ...
        ItemPromoteVerticalListAdapter itemPromoteVerticalListAdapter = new ItemPromoteVerticalListAdapter(dataBindingComponent,
                new ItemPromoteVerticalListAdapter.NewsClickCallback() {
                    ...
                    public void onClick(ItemPaidHistory itemPaidHistory) {
                        navigationController.navigateToItemDetailActivity(LoginUserPaidItemFragment.this.getActivity(), itemPaidHistory.item.id, itemPaidHistory.item.title, itemPaidHistory.item.catId, itemPaidHistory.item.subCatId);
                    }
                },this);
