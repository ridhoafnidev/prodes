...
import com.mrii.prodes.databinding.FragmentItemEditBinding;
import com.mrii.prodes.databinding.ItemEntryBottomBoxBinding;
 ...
 */
public class ItemEditFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    @VisibleForTesting
    private AutoClearedValue<FragmentItemEditBinding> binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentItemEditBinding dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_item_edit, container, false, dataBindingComponent);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE__SEARCH_FRAGMENT && resultCode == Constants.RESULT_CODE__SEARCH_WITH_CATEGORY) {
            ...
            itemViewModel.addressValue = data.getStringExtra(Constants.USER_ADDRESS);
            ...
            bindingAddress(itemViewModel.addressValue);
        }
        ...
        if ((requestCode == Constants.REQUEST_CODE__FIRST_GALLERY || requestCode == Constants.REQUEST_CODE__SEC_GALLERY || requestCode == Constants.REQUEST_CODE__THIRD_GALLERY ||
            ...
            if (requestCode == Constants.REQUEST_CODE__FIRST_GALLERY) {
                ...
                itemViewModel.firstImagePath = convertToImagePath(data, selectedImage, filePathColumn);
            ...
            if (requestCode == Constants.REQUEST_CODE__SEC_GALLERY) {
                ...
                itemViewModel.secImagePath = convertToImagePath(data, selectedImage, filePathColumn);
            ...
            if (requestCode == Constants.REQUEST_CODE__THIRD_GALLERY) {
                ...
                itemViewModel.thirdImagePath = convertToImagePath(data, selectedImage, filePathColumn);
            ...
            if (requestCode == Constants.REQUEST_CODE__FOURTH_GALLERY) {
                ...
                itemViewModel.fourthImagePath = convertToImagePath(data, selectedImage, filePathColumn);
            ...
            if (requestCode == Constants.REQUEST_CODE__FIFTH_GALLERY) {
                ...
                itemViewModel.fifthImagePath = convertToImagePath(data, selectedImage, filePathColumn);
...
//        }
        ...
        binding.get().subCategorySelectionView.setOnClickListener(view -> {
            ...
            if (catId.equals(Constants.NO_DATA) || catId.isEmpty()) {
                ...
                showWarningDialog(getString(R.string.error_message__choose_category), getString(R.string.app__ok));
        ...
        binding.get().mapViewButton.setOnClickListener(v -> {
            ...
            if(itemViewModel.itemId.equals(Constants.ADD_NEW_ITEM)){
                navigationController.navigateToMapActivity(ItemEditFragment.this.getActivity(), selectedLng, selectedLat, Constants.MAP_PICK);
            }else {
                navigationController.navigateToMapActivity(ItemEditFragment.this.getActivity(), itemViewModel.mapLng, itemViewModel.mapLat, Constants.MAP_PICK);
            }
        ...
        binding.get().submitButton.setOnClickListener(view -> {
            ...
            if ( ( itemViewModel.firstImagePath.equals("") && firstImageId.equals("") )
                ...
                showWarningDialog(ItemEditFragment.this.getString(R.string.item_entry_need_image), ItemEditFragment.this.getString(R.string.app__ok));
            } else if (binding.get().titleEditText.getText().toString().isEmpty()) {
                showWarningDialog(ItemEditFragment.this.getString(R.string.item_entry_need_list_title), ItemEditFragment.this.getString(R.string.app__ok));
            }
            else if (binding.get().categoryTextView.getText().toString().isEmpty()) {
                showWarningDialog(ItemEditFragment.this.getString(R.string.item_entry_need_category), ItemEditFragment.this.getString(R.string.app__ok));
            }
...
//            }
                ...
                showWarningDialog(ItemEditFragment.this.getString(R.string.item_entry_need_item_condition), ItemEditFragment.this.getString(R.string.app__ok));
            }
...
//            }
                ...
                showWarningDialog(ItemEditFragment.this.getString(R.string.item_entry_need_description), ItemEditFragment.this.getString(R.string.app__ok));
            } else if (binding.get().priceEditText.getText().toString().isEmpty()) {
                showWarningDialog(ItemEditFragment.this.getString(R.string.item_entry_need_price), ItemEditFragment.this.getString(R.string.app__ok));
            }
...
//            }
                ...
                ItemEditFragment.this.getImagePathList();

                ItemEditFragment.this.checkIsShop();

                if (itemViewModel.itemId != null) {
                    if (!itemViewModel.itemId.equals(Constants.ADD_NEW_ITEM)) {//edit
                        itemViewModel.setUploadItemObj(ItemEditFragment.this.catId, ItemEditFragment.this.subCatId, ItemEditFragment.this.typeId, ItemEditFragment.this.priceTypeId, ItemEditFragment.this.currencyId, ItemEditFragment.this.conditionId, ItemEditFragment.this.locationId,
                                binding.get().remarkEditText.getText().toString(), binding.get().descEditText.getText().toString(),
                                binding.get().highlightInfoEditText.getText().toString(), binding.get().priceEditText.getText().toString(), ItemEditFragment.this.dealOptionId,
...
//    }
    ...
    public void showWarningDialog(String choice, String oke){
        ...
        itemViewModel.getUploadItemData().observe(this, result -> {
            ...
            if (result != null) {
                ...
                switch (result.status) {
                    ...
                    case ERROR:
                        showWarningDialog(getString(R.string.error_message__item_cannot_upload), getString(R.string.app__ok));
                        break;
                }
            }
...
//                            Toast.makeText(ItemEntryFragment.this.getActivity(), "Success image : "+toastImageCount+" uploaded", Toast.LENGTH_SHORT).show();
                            ...
                            if (imagePathList.size() > imageCount) {
                                ItemEditFragment.this.callImageUpload(imageCount);//first is one
                            } else {
...
//                        }
                    ...
                    case ERROR:
                        Toast.makeText(ItemEditFragment.this.getActivity(), "Error", Toast.LENGTH_SHORT).show();
                        showWarningDialog(ItemEditFragment.this.getString(R.string.error_message__image_cannot_upload), ItemEditFragment.this.getString(R.string.app__ok));
                        break;
                }
...
//                itemViewModel.fifthImagePath = imageList.get(4).imgPath;
    ...
    private void bindingAddress(String addressValue) {
        binding.get().addressEditText.setText(addressValue);
    }
