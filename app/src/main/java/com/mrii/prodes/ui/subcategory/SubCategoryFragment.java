...
import com.mrii.prodes.databinding.FragmentSubCategoryBinding;
import com.mrii.prodes.ui.common.DataBoundListAdapter;
import com.mrii.prodes.ui.common.PSFragment;
import com.mrii.prodes.ui.subcategory.adapter.SubCategoryAdapter;
    ...
    protected void initAdapters() {
        SubCategoryAdapter nvAdapter = new SubCategoryAdapter(dataBindingComponent, new SubCategoryAdapter.SubCategoryClickCallback() {
            ...
            public void onClick(ItemSubCategory subCategory) {
                ...
                navigationController.navigateToHomeFilteringCategoryActivity(SubCategoryFragment.this.getActivity(), itemParameterHolder, subCategory.name, selectedCityLat, selectedCityLng, Constants.MAP_MILES);
