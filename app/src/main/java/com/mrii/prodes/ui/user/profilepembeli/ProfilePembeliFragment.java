package com.mrii.prodes.ui.user.profilepembeli;
 ...
 * ProfileFragment
 */
public class ProfilePembeliFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    @VisibleForTesting
    private AutoClearedValue<FragmentProfilePembeliBinding> binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        FragmentProfilePembeliBinding dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_profile_pembeli, container, false, dataBindingComponent);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.menu_profile_pembeli, menu);
    ...
    protected void initUIAndActions() {
        ...
        binding.get().llShare.setOnClickListener(view -> share());
...
//                navigationController.navigateToItemListActivity(getActivity(), loginUserId, Constants.FLAGNOPAID, Constants.TWO, getString(R.string.profile__disabled_listing)));
        ...
        binding.get().followingUserTextView.setOnClickListener(view -> navigationController.navigateToUserListActivity(ProfilePembeliFragment.this.getActivity(), new UserParameterHolder().getFollowingUsers()));
        binding.get().followUserTextView.setOnClickListener(view -> navigationController.navigateToUserListActivity(ProfilePembeliFragment.this.getActivity(), new UserParameterHolder().getFollowerUsers()));
   ...
   public void share(){
    ...
    protected void initAdapters() {
        ...
        ItemVerticalListAdapter nvAdapter = new ItemVerticalListAdapter(dataBindingComponent,
                item -> navigationController.navigateToItemDetailActivity(ProfilePembeliFragment.this.getActivity(), item.id, item.title, item.catId, item.subCatId), this);
        ...
        ItemHorizontalListAdapter pendingAdapter = new ItemHorizontalListAdapter(dataBindingComponent, new ItemHorizontalListAdapter.NewsClickCallback() {
            ...
            public void onClick(Item item) {
                navigationController.navigateToItemDetailActivity(ProfilePembeliFragment.this.getActivity(), item.id, item.title, item.catId, item.subCatId);
            }
        }, this);
                    ...
                    switch (listResource.status) {
                        case LOADING:
                            ...
                            if (listResource.data != null) {
                                //fadeIn Animation
                                ProfilePembeliFragment.this.fadeIn(binding.get().getRoot());

                                binding.get().setUser(listResource.data);
                                Utils.psLog("Photo : " + listResource.data.userProfilePhoto);

                                ProfilePembeliFragment.this.replaceUserData(listResource.data);
                        ...
                        case ERROR:
                            ...
                            psDialogMsg.showErrorDialog(listResource.message, ProfilePembeliFragment.this.getString(R.string.app__ok));
                            psDialogMsg.show();
